...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _c(
        "view",
        { staticClass: _vm._$s(13, "sc", "pt-2"), attrs: { _i: 13 } },
        [
          _c(
            "view",
            {
...
"use strict";
eval("Object.defineProperty(exports, \"__esModule\", { value: true });exports.default = void 0;\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nvar _navBar = _interopRequireDefault(__webpack_require__(/*! @/components/common/nav-bar.vue */ 7));\nvar _flieFolderList = _interopRequireDefault(__webpack_require__(/*! @/components/list/flieFolderList.vue */ 18));\nvar _fList = _interopRequireDefault(__webpack_require__(/*! @/components/common/f-list.vue */ 24));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} //\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n// import uniStatusBar from '@/components/uni-ui/uni-status-bar/uni-status-bar.vue'\nvar files = [{ image: '/static/icons/folder_48px.png', filename: '我的笔记', time: 1603333049, checked: false }, { image: '/static/icons/image_48px.png', filename: '风景.jpg', time: 160333049, checked: false }, { image: '/static/icons/video_file_48px.png', filename: 'uniapp实战教程.mp4', time: 15976927, checked: false }, { image: '/static/icons/notepad_48px.png', filename: '记事本.txt', time: 1540176927, checked: false }, { image: '/static/icons/zip_48px.png', filename: '压缩包.rar', time: 1403373639, checked: false }];var list = [{ type: 'dir', name: '我的笔记', create_time: '2020-10-21 08:00', checked: false },\n{\n  type: 'image',\n  name: '风景.jpg',\n  create_time: '2020-10-21 08:00',\n  checked: false },\n\n{\n  type: 'video',\n  name: 'uniapp实战教程.mp4',\n  create_time: '2020-10-21 08:00',\n  checked: false },\n\n{\n  type: 'text',\n  name: '记事本.txt',\n  create_time: '2020-10-21 08:00',\n  checked: false },\n\n{\n  type: 'none',\n  name: '压缩包.rar',\n  create_time: '2020-10-21 08:00',\n  checked: false }];var _default =\n\n\n\n{\n  components: {\n    // uniStatusBar\n    navBar: _navBar.default,\n    fileFolderList: _flieFolderList.default,\n    fList: _fList.default },\n\n  data: function data() {\n    return {\n      list: [] };\n\n  },\n  props: {\n    item: Object,\n    index: [Number, String] },\n\n  onLoad: function onLoad() {\n    // this.list = files;\n    this.list = list;\n  },\n  methods: {\n    select: function select(e) {\n      //接收到子组件传递过来的索引选中状态，将对应的list中的数据更新\n      this.list[e.index].checked = e.value;\n    } },\n\n  computed: {\n    //选中列表\n    checkList: function checkList() {\n      return this.list.filter(function (item) {return item.checked;});\n    },\n    //选中数量\n    checkCount: function checkCount() {\n      return this.checkList.length;\n    } } };\n\n\n\n/*\n           <template>\n           \t<view>\n           \t<!-- \tuni.request({\n           \t\t\turl: 'http://localhost:7001/list',\n           \t\t\tmethod: 'GET',\n           \t\t\tsuccess: res => {\n           \t\t\t\tconsole.log(res.data.data)\n           \t\t\t}\n           \t\t}) -->\n           \t\t\n           \t\t<!--  自定义导航栏 -->\n           \t\t<view>\n           \t\t\t<!-- 驼峰式自动转换为中划线式 -->\n           \t\t\t<!-- 顶部 -->\n           \t\t\t<uni-status-bar>\n           \t\t\t\t<!-- 此处不为rpx -->\n           \t\t\t\t<view style=\"height: 44px;\" class=\"flex border-bottom align-center\">\n           \t\t\t\t\t<view class=\"flex-1 flex\">\n           \t\t\t\t\t\t<!-- ml  margin left 32 -->\n           \t\t\t\t\t\t<text class=\"font-md ml-3\">首页</text>\n           \t\t\t\t\t</view>\n           \t\t\t\t\t<view class=\"flex-1 flex justify-center\"></view>\n           \t\t\t\t\t<view class=\"flex-1 flex justify-end\">\n           \t\t\t\t\t\t<view style=\"width: 60rpx;height: 60rpx;\" class=\"flex align-center justify-center bg-light rounded-circle mr-3\">\n           \t\t\t\t\t\t\t<text class=\"iconfont icon-zengjia\"></text>\n           \t\t\t\t\t\t</view>\n           \t\t\t\t\t\t<view style=\"width: 60rpx;height: 60rpx;\" class=\"flex align-center justify-center bg-light rounded-circle mr-3\">\n           \t\t\t\t\t\t\t<text class=\"iconfont icon-gengduo\"></text>\n           \t\t\t\t\t\t</view>\n           \t\t\t\t\t</view>\n           \t\t\t\t</view>\n           \t\t\t</uni-status-bar>\n           \t\t</view> \n           \t</view>\n           \n           </template>\n           \n           */exports.default = _default;//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///6\n");
...
"use strict";
eval("Object.defineProperty(exports, \"__esModule\", { value: true });exports.default = void 0; //\n//\n//\n//\n//\n//\n//\n//\nvar _default =\n{\n  data: function data() {\n    return {\n      title: 'my' };\n\n  },\n  onLoad: function onLoad() {\n\n  },\n  methods: {} };exports.default = _default;//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///33\n");
...
"use strict";
eval("Object.defineProperty(exports, \"__esModule\", { value: true });exports.default = void 0; //\n//\n//\n//\n//\n//\n//\n//\nvar _default =\n{\n  data: function data() {\n    return {\n      title: 'list' };\n\n  },\n  onLoad: function onLoad() {\n\n  },\n  methods: {} };exports.default = _default;//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///38\n");
