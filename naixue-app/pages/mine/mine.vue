<template>
	<view class="container">
		<view class="position-relative">
			...
			<button type="default" size="mini" class="hym-btn" @click="code">
				<image src="/static/images/mine/hym.png"></image>
				<text>会员码</text>
			</button>
		</view>
		<view style="padding: 0 30rpx;">
			<view class="d-flex flex-column bg-white user-box" style="display: flex;">
				<view class="d-flex align-items-center" style="display: flex;">
					<view class="avatar">
