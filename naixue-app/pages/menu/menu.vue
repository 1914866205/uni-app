		...
		<view class="main">
			...
			<view class="content">
				...
				<scroll-view scroll-y="true" class="menus" :scroll-into-view="menuScrollIntoView">
					<view class="wrapper">
						<view class="menu" :id="`menu-${item._id}`" :class="{ current: item._id === currentCateId }" v-for="(item, index) in goods"
						 :key="index" @tap="handleMenuTap(item._id)">
							<text>{{ item.name }}</text>
										...
										<view class="right">
											...
											<view class="price_and_action">
												...
												<view class="btn-group" v-else>
													<button type="default" v-show="goodCartNum(good._id)" plain class="btn reduce_btn" size="mini" hover-class="none"
